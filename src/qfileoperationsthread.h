...
public:
	...
	static bool isInSameDisc(const QString& source,const QString& dest);
	...
	static bool getDiskSpace(const QString& fileName,qint64& availableBytes,qint64& totalBytes,qint64 &freeBytes);
	static QString getDiskLabel(const QString& fileName);
private:
