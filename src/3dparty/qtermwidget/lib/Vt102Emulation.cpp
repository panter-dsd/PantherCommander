...
// resize = \e[8;<row>;<col>t
        ...
        for (i = 0; i <= argc; i++) {
            ...
            else if (cc == 'm' && argc - i >= 4 && (argv[i] == 38 || argv[i] == 48) && argv[i + 1] ==
                                                                                       2) { // ESC[ ... 48;2;<red>;<green>;<blue> ... m -or- ESC[ ... 38;2;<red>;<green>;<blue> ... m
                i += 2;
                tau (TY_CSI_PS(cc, argv[i - 2]), COLOR_SPACE_RGB, (argv[i] << 16) | (argv[i + 1] << 8) | argv[i + 2]);
                i += 2;
            } else if (cc == 'm' && argc - i >= 2 && (argv[i] == 38 || argv[i] == 48) &&
                       argv[i + 1] == 5) { // ESC[ ... 48;5;<index> ... m -or- ESC[ ... 38;5;<index> ... m
                i += 2;
...
void Vt102Emulation::reportSecondaryAttributes ()
{
    ...
    if (getMode (MODE_Ansi)) {
        ...
        sendString ("\033/Z");
    }         // FIXME I don't think VT52 knows about it but kept for
